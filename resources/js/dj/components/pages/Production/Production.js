...
import shared from '../../../../media/components/pages/Projects/Projects.css'
	...
	return (
		<div>
            ...
            {production.loading === true ? <Pace color="#27ae60" height="10px"/> : (
                <div>
                    <div className={classNames(style.mashups, shared.projects)}>
                        <h1>Mashups</h1>
                    ...
                    <div className={classNames(style.mixes, shared.projects)}>
                        <h1>Mixes</h1>
                        <table className={shared.table}>
                            <tbody>
                            {mixes}
